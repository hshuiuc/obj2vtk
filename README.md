 this project converts Wavefront OBJ files to VTK Legacy Format polygonal data files. Both formats have many features, but you this project only implement a specific subset.
